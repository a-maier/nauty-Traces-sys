/*****************************************************************************
* This is the main header file for gtools.  nauty version 2.8.9
...
#define HAVE_CRYPTO @have_crypto@  /* crypto library available */
...
extern graph *readg_loops(FILE*,graph*,int,int*,int*,int*,boolean*);
...
extern int setlabptnfmt(char*,int*,int*,set*,int,int);
...
extern void countorbits(graph*,int,int,boolean,double*,int*,
